...
+ machine_id
+ processing_time (rounded to three decimal places)
...
Время выполнения процесса вычисляется как: end_timestamp - 
...
+ machine_id
+ processing_time (округленное до трёх знаков после запятой)
