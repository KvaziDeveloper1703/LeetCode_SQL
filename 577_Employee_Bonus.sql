...
+ The ID of the supervisor (supervisor)—this indicates the employee’s manager. If the value is NULL, the employee does not have a supervisor (e.g., they are at the top level).
