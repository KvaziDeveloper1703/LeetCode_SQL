...
Даны три таблицы: студенты, предметы и экзамены.

Таблица студенты содержит список учащихся с их уникальными идентификаторами и именами. Каждая строка представляет одного студента.
+ student_id – Уникальный идентификатор студента.
+ student_name – Имя студента.

Таблица предметы содержит названия всех предметов, изучаемых в школе. Каждая строка представляет один предмет.
+ subject_name – Название предмета (уникально для каждого предмета).

Таблица экзамены фиксирует, какие студенты сдавали экзамены по каким предметам. Один студент может сдавать один и тот же экзамен несколько раз, а некоторые студенты могут не сдавать экзамены вовсе.
