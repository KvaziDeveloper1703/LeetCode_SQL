...
Annetaan kaksi taulua: Employee ja Bonus.

Taulu Employee sisältää tietoa työntekijöistä, mukaan lukien heidän yksilöllisen ID:nsa, nimensä, palkkansa sekä esihenkilönsä ID:n. Jokainen rivi edustaa yhtä työntekijää.
Jokainen tämän taulun rivi sisältää:
    - työntekijän ID (empId), joka on uniikki jokaiselle työntekijälle;
    - työntekijän nimen (name);
    - esihenkilön ID:n (supervisor) - tämä on kyseisen työntekijän esimiehen tunniste. Jos arvo on NULL, työntekijällä ei ole esihenkilöä (esimerkiksi jos hän on organisaation ylimmässä asemassa);
    - työntekijän palkan (salary).

Taulu Bonus sisältää tietoa työntekijöiden bonuksista. Jokainen rivi edustaa yhden työntekijän bonusmerkintää. Kaikilla työntekijöillä ei kuitenkaan ole merkintää tässä taulussa.

Jokainen tämän taulun rivi sisältää:
    - työntekijän ID:n (empId), joka viittaa taulun Employee empId-sarakkeeseen (vierasavain);
    - bonuksen määrän (bonus), jonka työntekijä sai. Jos työntekijällä ei ole riviä tässä taulussa, se tarkoittaa, että hän ei saanut bonusta.

Kirjoita SQL-kysely, joka palauttaa niiden työntekijöiden nimen ja bonuksen määrän, joilla bonus on alle 1000.
Jos työntekijällä ei ole bonusmerkintää, bonuksen tulee näkyä arvona NULL.
